...
class BarcodeGenerator {
    ...
    fun generate(barcode: Barcode, outputFormat: OutputFormat): ByteArray {
        logger.debug { "Generating ${barcode.barcodeType} barcode in format '$outputFormat' with content '${barcode.content}'..." }
        ...
        logger.debug { "Generated ${barcode.barcodeType} barcode in format '$outputFormat' with content '${barcode.content}'." }
